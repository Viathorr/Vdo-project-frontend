  ...
  return (
    <div className="feed-question-card">
      ...
      <div className="question-footer">
          ...
          { updateClicked
          ? <div>
            <button className="cancel-btn btn" onClick={() => setUpdateClicked(false)}>Cancel</button>
            <button className="submit-btn btn" disabled={ questionContent.length < 10 || questionContent.length > 255 || questionContent.replace(/\s/g, '').length == 0 ? true : false }>Submit</button>
            </div>
            : null
          }
      </div>
